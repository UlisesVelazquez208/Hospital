    ...
    export default {
        ...
        computed: {
            comments: function () {
                ...
                return this.faqModel.comments.filter(comment => comment.section == 'SOCIAL_MEDIA_LINKS');
            }
        },
        // ===Component methods
        methods: {
            loadLinks: function () {
                const mediaLinks = this.faqModel.social_media_links;
            ...
            ValidURL: function (url, type='socialLink') {
                ...
                // console.log(pattern, url.match(pattern), pattern.test(url));
